...
BUILTIN_TOOL_DESCRIPTIONS: Dict[str, str] = {
    ...
    "fincept": "Run a FinceptTerminal finance analytics script and return structured JSON. Available scripts: portfolioManagement/fetch_quotes (live bid/ask prices), portfolioManagement/fetch_historical (OHLCV history), portfolioManagement/portfolio_optimization (max-Sharpe weights), portfolioManagement/quantstats_analysis (Sharpe/Sortino/drawdown), portfolioManagement/ffn_analysis (Calmar/monthly returns), portfolioManagement/portfolio_analytics (performance attribution). Use for 'get quotes for', 'fetch prices', 'portfolio analysis', 'stock history', 'optimize portfolio'.",
}
